...
function root:api/debug/message/success {sys:"3d_triggers", message:"Shown all displays"}

scoreboard players add K-Engine.3d_triggers.node_list.size K-Engine.3d_triggers 1

function sys:3d_triggers/private/_show_block_displays with storage k-e:3d_triggers node_list