...
$execute if score K-Engine.dialogue.$(id).current_delay K-Engine.dialogue matches ..0 run function sys:dialogue/private/_typing with storage k-e:dialogue $(id)
