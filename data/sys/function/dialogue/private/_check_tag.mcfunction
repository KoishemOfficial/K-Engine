$execute if data storage k-e:dialogue $(id).import[$(index)].tag{type:"step"} run function sys:dialogue/private/_set_step with storage k-e:dialogue $(id)
...
$execute if data storage k-e:dialogue $(id).import[$(index)].tag{type:"typing"} run function sys:dialogue/private/_typing_redirect with storage k-e:dialogue $(id)
