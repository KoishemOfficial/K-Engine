...
$execute unless score K-Engine.flush.node_list.id K-Engine.flush >= K-Engine.flush.node_list.sizeK-Engine.flush run function sys:flush/private/_run with storage k-e:flush $(sys)

$execute if score K-Engine.flush.node_list.id K-Engine.flush = K-Engine.flush.node_list.size K-Engine.flush run function sys:flush/private/_clear_temp with storage k-e:flush $(sys)