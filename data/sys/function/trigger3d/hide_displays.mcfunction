...
function root:api/debug/message/success {sys:"trigger3d", message:"Hid all displays"}

scoreboard players add K-Engine.trigger3d.node_list.size K-Engine.trigger3d 1

function sys:trigger3d/private/_hide_block_displays with storage k-e:trigger3d node_list