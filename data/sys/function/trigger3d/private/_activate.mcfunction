...
$execute if score K-Engine.trigger3d.$(id).triggered K-Engine.trigger3d matches 1 if score K-Engine.trigger3d.$(id).triggered_prev K-Engine.trigger3d matches 0 as $(filter) run function sys:hooks/emit {sys:"trigger3d",hook:enter,node:$(id)}
$execute if score K-Engine.trigger3d.$(id).triggered K-Engine.trigger3d matches 0 if score K-Engine.trigger3d.$(id).triggered_prev K-Engine.trigger3d matches 1 as $(filter) run function sys:hooks/emit {sys:"trigger3d",hook:exit,node:$(id)}
